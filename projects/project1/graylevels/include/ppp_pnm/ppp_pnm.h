 ...
 * Valid values for the red, green and blue components or
 * the gray value of a pixel, respectively, are in the range
 * 0 .. maxval (both bounds included).
 * The image data is stored in row major order in the returned array.
 * PBM and PGM images use one entry per pixel, PPM images use three
